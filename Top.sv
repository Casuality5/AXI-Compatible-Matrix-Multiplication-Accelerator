module Top(
    ...
    logic [31:0] PERFORMANCE_WIRE;
    logic [31:0] STATUS_WIRE;
    logic [3:0] STAGE_WIRE;
    ...
    assign STATUS_REG = STATUS_WIRE;
    
    Memory_Mapped_IO MMIO_INST (
          .CLK(CLK),
          .RST(RST),
          .CURRENT_STATE(STAGE_WIRE),
          .DATA(MMIO_DATA),
          ...
          .HW_STATUS(STATUS_WIRE),
          .HW_PERFORMANCE(PERFORMANCE_WIRE),
