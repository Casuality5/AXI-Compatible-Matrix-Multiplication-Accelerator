module DMAC(
    ...
    output logic [31:0] HW_PERFORMANCE,
    output logic [31:0] HW_STATUS,
    output logic CURRENT_STAGE
    );
...
always_ff @ (posedge CLK) begin
    ...
    if (CURRENT_STATE == IDLE) HW_PERFORMANCE = 0;
    
    else HW_PERFORMANCE = HW_PERFORMANCE + 1;
...
assign HW_STATUS = (CURRENT_STATE != IDLE);
assign CURRENT_STAGE = CURRENT_STATE;    
